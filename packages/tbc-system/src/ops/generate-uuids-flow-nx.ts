...
class StartNode extends HAMINode<Shared, Config> {
    ...
    kind(): string {
        return 'tbc-system:generate-uuids-flow-start:nx';
    }
...
export class GenerateUUIDsFlowNx extends HAMIFlow<Record<string, any>, Config> {
    startNode: Node;
    config: Config;
    ...
    kind(): string {
        return 'tbc-system:generate-uuids-flow:nx';
    }
