...
### Generic Interface (`int generic`)

* Generates a generic `AGENTS.md` file in the repository root with system instructions for AI assistants to operate as the TBC companion.

```bash
$ tbc int generic --help
Usage: tbc int generic [options]

Generate generic AI assistant interface configuration
...
* Generates unique identifiers for TBC records.
