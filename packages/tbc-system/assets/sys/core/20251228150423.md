...
1. Search the `skills/` collection for a `SKILL.md` containing a metadata tag matching the Method name.
2. If multiple skills match, prioritize `skills/core/` over `skills/ext/`.
