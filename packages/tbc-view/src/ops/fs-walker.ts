...
export class FSWalkerNode extends HAMINode<TBCViewStorage> {
    constructor(maxRetries?: number, wait?: number) {
        super(maxRetries, wait);
    }

    kind(): string {
        return "tbc-view:fs-walker";
    }

    async prep(shared: TBCViewStorage): Promise<FSWalkerInput> {
    ...
    async post(shared: TBCViewStorage, _prepRes: FSWalkerInput, execRes: FSWalkerOutput): Promise<string | undefined> {
