...
export class RepairRecommendationsNode extends HAMINode<TBCViewStorage> {
    constructor(maxRetries?: number, wait?: number) {
        super(maxRetries, wait);
    }

    kind(): string {
        return "tbc-view:repair-recommendations";
    }

    async prep(shared: TBCViewStorage): Promise<RepairRecommendationsInput> {
    ...
    async post(shared: TBCViewStorage, _prepRes: RepairRecommendationsInput, execRes: RepairRecommendationsOutput): Promise<string | undefined> {
