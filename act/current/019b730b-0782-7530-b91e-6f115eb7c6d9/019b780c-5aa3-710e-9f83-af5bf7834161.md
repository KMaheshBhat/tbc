...
### Step 1: General Temporal Knowledge Graph (TKG) Schema & ViewStore
...
### Step 2: The Graph-Miner (HAMIFlow Engine)
...
### Step 3: SRE Integrity Reporting & Repair
...
### Step 4: CLI Integration & Commands - `view index`

**Objective**: Integrate the TKG system into the TBC CLI with new commands for building TKG index.
...
### Step 5: CLI Integration & Commands - `view health`

**Objective**: Integrate the TKG system into the TBC CLI with new commands for full health report.
...
**5.4 Test**
- Test `tbc view health`.
- Fix issues that arise.

### Step 6: CLI Integration & Commands - `view status`

**Objective**: Integrate the TKG system into the TBC CLI with new commands for quick health summary.
...
**6.4 Test**
- Test `tbc view status`.
- Fix issues that arise.

### Step 7: CLI Integration & Commands - `view audit`

**Objective**: Integrate the TKG system into the TBC CLI with new commands for comprehensive audit with repair suggestions.
...
**7.2 CLI Flow Implementation**
Create new flows in `apps/tbc-cli/src/ops/`:

- **ViewAuditFlow**: Combines indexing + health checking + repair suggestions

**7.3 Command Registration**
Update CLI command definitions to include new view subcommands with proper help text and option parsing.
